...
@section('title', 'About')
@section('about_active') class="active" @endsection
@section('bradcam_title', 'About')
        ...
        <div class="row">
            <div class="col-xl-5 col-lg-6">
                <div class="single_about_info">
                    ...
                    <a href="/course" class="boxed_btn">Enroll a Course</a>
                </div>
            </div>
...
<div class="our_team_member">
    <div class="container">
        <div class="row">
            @foreach($about as $person)
            <div class="col-xl-3 col-md-6 col-lg-3">
                <div class="single_team">
                    <div class="thumb">
                        <img src="{{ $person->source_image }}" alt="">
                    ...
                    <div class="master_name text-center">
                        <h3>{{ $person->source_name }}</h3>
                        <p>{{ $person->source_profession }}</p>
                    </div>
                </div>
            </div>
            @endforeach
